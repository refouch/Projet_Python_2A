...
def scrape_first_table(url):
    """ Fonction prenant en argument un lien pour retourner le premier tableau de la page
        Arguments: url (str)
...
def scrape_second_wikipedia_table(url):
    """ Fonction prenant en argument un lien wikipedia pour retourner le second tableau de la page
        Arguments: url (str)
        Return: table (bs4 element)
    """
    request = rq.get(url)
